    ...
    Canvas(modifier = modifier.size(size)) {
        ...
        drawCircle(
            brush = Brush.radialGradient(
                colors = listOf(
                    FitsizeColor.Indigo.copy(alpha = 0.16f),
                    FitsizeColor.Indigo.copy(alpha = 0.02f),
                ),
                center = centre,
                radius = radius * 1.5f,
            ),
        ...
        drawCircle(
            color = FitsizeColor.Indigo.copy(alpha = 0.07f),
            radius = radius * 1.16f,
            center = centre,
        )
        drawCircle(
            color = FitsizeColor.Indigo.copy(alpha = 0.10f),
            radius = radius * 0.88f,
            center = centre,
        )
        ...
        drawCircle(
            color = FitsizeColor.Indigo.copy(alpha = 0.18f),
            radius = radius * 1.34f,
            center = centre,
        ...
        drawRoundRect(
            color = FitsizeColor.Indigo.copy(alpha = 0.16f),
            topLeft = cardTopLeft,
            size = Size(cardW, cardH),
            cornerRadius = CornerRadius(w * 0.055f, w * 0.055f),
            style = Stroke(width = 1.dp.toPx()),
        ...
        drawPath(path = play, brush = FitsizeColor.PrimaryGradient)
        ...
        drawRoundRect(
            color = FitsizeColor.Mint.copy(alpha = 0.45f),
        ...
        drawSparkle(Offset(w * 0.90f, h * 0.16f), w * 0.035f, FitsizeColor.Violet.copy(alpha = 0.5f))
        drawSparkle(Offset(w * 0.10f, h * 0.72f), w * 0.026f, FitsizeColor.Indigo.copy(alpha = 0.35f))
    }
}
