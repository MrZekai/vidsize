...
/**
 * Material 3 typography mapped onto the Fitsize scale, so any Material
 * component picking up a default style still looks like the rest of the app.
 */
val FitsizeTypography = Typography(
    displaySmall = FitsizeType.hero,
    headlineMedium = FitsizeType.screenTitle,
    headlineSmall = FitsizeType.figure,
    titleLarge = FitsizeType.section,
    titleMedium = FitsizeType.cardTitle,
    bodyLarge = FitsizeType.body,
    bodyMedium = FitsizeType.supporting,
    bodySmall = FitsizeType.caption,
    labelLarge = FitsizeType.button,
    labelMedium = FitsizeType.caption,
    labelSmall = FitsizeType.micro,
)
